...
export const STATUS_EFFECTS = [
    ...
    },
    {
        ...
        flags: { convenientDescription: "<p>You cannot speak and cannot cast spells with a verbal component.</p><p>You automatically fail any ability checks that require speech.</p>" }
    },
    {
    ...
    },
    {
        ...
        flags: { convenientDescription: "<p>You are incapacitated, and you cannot move or speak.</p><p>You automatically fail Strength and Dexterity saving throws.</p><p>Attack rolls against you have advantage, and any attacks against you is a critical hit if the attacker is within 5 feet of you.</p>" },
        changes: [
            { key: "system.attributes.movement.walk", mode: CONST.ACTIVE_EFFECT_MODES.MULTIPLY, value: 0 },
            { key: "system.attributes.movement.fly", mode: CONST.ACTIVE_EFFECT_MODES.MULTIPLY, value: 0 },
            { key: "system.attributes.movement.swim", mode: CONST.ACTIVE_EFFECT_MODES.MULTIPLY, value: 0 },
    ...
    },
    {
        ...
        flags: { convenientDescription: "<p>You are inanimate, incapacitated, and unaware of your surroundings.</p><p>Your weight is increased by a factor of ten, you cannot move or speak, and attack rolls against you have advantage.</p><p>You automatically fail all Strength and Dexterity saving throws.</p><p>You have resistance to all damage, and you are immune to poison and disease.</p>" }
    },
    {
    ...
    },
    {
        ...
        flags: { convenientDescription: "<p>You can only crawl unless you expend half your movement to stand up.</p><p>You have disadvantage on attack rolls, and any attack roll has advantage against you if the attacker is within 5 feet of you; it otherwise has disadvantage.</p>" }
    },
    {
    ...
    },
    {
        ...
        flags: { convenientDescription: "<p>You are incapacitated, cannot move or speak, you fall prone, and you automatically fail all Strength and Dexterity saving throws.</p><p>Attack rolls against you have advantage, and any attack that hits you is a critical hit if the attacker is within 5 feet of you.</p>" },
        changes: [
            { key: "system.attributes.movement.walk", mode: CONST.ACTIVE_EFFECT_MODES.MULTIPLY, value: 0 },
            { key: "system.attributes.movement.fly", mode: CONST.ACTIVE_EFFECT_MODES.MULTIPLY, value: 0 },
            { key: "system.attributes.movement.swim", mode: CONST.ACTIVE_EFFECT_MODES.MULTIPLY, value: 0 },
...
export const EXHAUSTION_EFFECTS = [
    {
        ...
        flags: {
            [MODULE]: { exhaustion: 1 },
            convenientDescription: "<p>You have disadvantage on all ability checks.</p>"
        },
        changes: [
    ...
    },
    {
        ...
        flags: {
            [MODULE]: { exhaustion: 2 },
            convenientDescription: "<p>You have disadvantage on all ability checks.</p><p>Your movement speed is halved.</p>"
        },
        changes: [
    ...
    },
    {
        ...
        flags: {
            [MODULE]: { exhaustion: 3 },
            convenientDescription: "<p>You have disadvantage on all ability checks, attack rolls, and saving throws.</p><p>Your movement speed is halved.</p>"
        },
        changes: [
    ...
    },
    {
        ...
        flags: {
            [MODULE]: { exhaustion: 4 },
            convenientDescription: "<p>You have disadvantage on all ability checks, attack rolls, and saving throws.</p><p>Your movement speed and your maximum hit points are halved.</p>"
        },
        changes: [
    ...
    },
    {
        ...
        flags: {
            [MODULE]: { exhaustion: 5 },
            convenientDescription: "<p>You have disadvantage on all ability checks, attack rolls, and saving throws.</p><p>You cannot move, and your hit point maximum is halved.</p>"
        },
        changes: [
