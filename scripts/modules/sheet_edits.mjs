...
export class SheetEdits {
  ...
  async render() {
    ...
    if ((this.sheet.document.type === "character") && this.settings.createMoneySpender) await this._createMoneySpender();
  }
  ...
  _onClickExhaustion(event) {
    ...
    const buttons = {
      up: {
        ...
        label: "Gain a Level",
        callback: EXHAUSTION.increaseExhaustion.bind(this)
      },
      down: {
        icon: "<i class='fa-solid fa-arrow-down'></i>",
        label: "Down a Level",
        callback: EXHAUSTION.decreaseExhaustion.bind(this)
      }
    };
